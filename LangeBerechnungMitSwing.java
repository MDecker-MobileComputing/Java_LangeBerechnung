 ...
 * (eigentlich nicht erlaubt) und in HintergrundThread.
 * <br><br>
 *
...
public class LangeBerechnungMitSwing extends JFrame {
	...
	/** UI-Element zur Eingabe der Zahl, fuer die die dritte Potenz berechnet werden soll */
	...
	/** Zeitstempel (Beginn der Berechnung mit System.currentTimeMillis() ) fuer Ermittelung der Berechnungsdauer. */
	protected static long sStartTimestamp = -1;
	
	/** NumberFormat-Objekt, wird fuer Formatierung und Bestimmung zulaessiger Eingabezahlen benoetigt. */
	...
	// *** Layout-Manager definieren ***
       ...
       // *** UI-Elemente erzeugen ***
		...
		// Ab Java8 kann der gerade definierte Event-Handler fuer den Button auch mit einem 
		...
		// *** Groesse/Postion des Fenster bestimmen ***
		setSize    (700, 500);
	...
	/**
	 * Abfrage der in  JFormattedTextField eingegeben Zahlen.
	 * 
	...
	/**
	 * Event-Handler fuer Button zur Berechnung im Main-Thread.
	 */
	protected void starteBerechnungInMainThread() {
		...
		zeitmessungStart();
		long ergebnis = berechnung(zahl); // funktioniert nicht fuer negative Zahlen
	...
	/**
	 * Event-Handler fuer Button zur Berechnung im Hintergrund-Thread.
	 */	
	 ...
	 * (naemlich mit einer dreifach gestaffelten Schleife).
	 * Je groesser der Wert <i>inputParameter</i> ist, desto laenger dauert sie.
	 * Achtung: Laufzeit waechst kubisch mit inputParameter!
	...
	/**
	 * Start der "Stoppuhr" fuer die Messung der Berechnungsdauer.
	 */
